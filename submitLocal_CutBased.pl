...
foreach $file (@datacards) 
  {
    ...
    $scriptCentral = "combine /afs/cern.ch/user/a/amassiro/scratch0/VBF/Limit/CMSSW_6_1_0/src/".$ARGV[0]."/$file -m ".$baseName[2]." -M Asymptotic  > asymptotic.".$baseName[0].".".$baseName[2].".".$ARGV[0].".out \n" ;
