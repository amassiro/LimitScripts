...
foreach $file (@datacards) 
  {
    ...
    $scriptCentral = "combine /afs/cern.ch/user/a/amassiro/scratch0/VBF/Limit/CMSSW_5_2_5/src/".$ARGV[0]."/$file -m ".$baseName[1]." -M Asymptotic  > asymptotic.".$baseName[0].".".$baseName[1].".".$ARGV[0].".OF.out \n" ;
